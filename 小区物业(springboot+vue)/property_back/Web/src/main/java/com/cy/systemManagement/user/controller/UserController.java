...
public class UserController {
    ...
    public CommonResult<User> deleteUser(@PathVariable("userId") long userId,HttpServletRequest request) {
        ...
        if (username.equals(one.getUsername())){
            ...
            QueryWrapper<UserRole> userRoleQueryWrapper2 = new QueryWrapper<>();
            userRoleQueryWrapper2.lambda().eq(UserRole::getUserId,userId);
            UserRole userRole = userRoleMapper.selectOne(userRoleQueryWrapper2);
            if (userRole != null) {
